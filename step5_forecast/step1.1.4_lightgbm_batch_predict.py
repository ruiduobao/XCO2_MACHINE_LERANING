...
if __name__ == "__main__":
    ...
    for i, (input_file, year, month) in enumerate(filtered_files):
        ...
        output_csv = os.path.join(OUTPUT_DIR, filename.replace('.csv', '_lightgbm_predictions.csv'))
        output_tif = os.path.join(OUTPUT_DIR, f"预测xco2_lightgbm_{year}_{month:02d}.tif")
