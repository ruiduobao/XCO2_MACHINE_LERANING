...
# 1. 加载 CSV 表格
csv_path = r'E:\地理所\论文\中国XCO2论文_2025.04\数据\训练表格数据\标准栅格数据\标准栅格XY\标准栅格XY_2018_01.csv' # 使用原始字符串或正斜杠
output_path = r'E:\地理所\论文\中国XCO2论文_2025.04\数据\训练表格数据\标准栅格数据\标准栅格XY_添加tif\统计_2008_01.csv' # 使用原始字符串或正斜杠
