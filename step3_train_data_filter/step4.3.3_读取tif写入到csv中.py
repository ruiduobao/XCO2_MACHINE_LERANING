...
# 1. 加载 CSV 表格
csv_path = r'E:\地理所\论文\中国XCO2论文_2025.04\数据\训练表格数据\卫星数据\网格XCO2加权统计_按年月.csv' # 使用原始字符串或正斜杠
...
# 6. 保存处理后的表格
output_path = r'E:\地理所\论文\中国XCO2论文_2025.04\数据\训练表格数据\卫星数据\处理后的网格XCO2加权统计_优化版.csv' # 使用原始字符串或正斜杠
