...
# --- 输入和输出文件路径 ---
input_path = r'E:\地理所\论文\中国XCO2论文_2025.04\数据\CLCD\原始数据_众数重采样\2018_CLCD_0_01deg_mode.tif'
output_path = r'E:\地理所\论文\中国XCO2论文_2025.04\数据\CLCD\原始数据_众数重采样_setnull\2018_CLCD_0_01deg_mode_NODATA9999.tif'
