...
def main():
    # 定义输入输出路径
    input_dir = r'E:\地理所\论文\中国XCO2论文_2025.04\数据\carbon_tracer\2018年柱浓度_tif_月平均值合成'
    output_dir = r'E:\地理所\论文\中国XCO2论文_2025.04\数据\carbon_tracer\2018年柱浓度_tif_月平均值合成_仿射'
